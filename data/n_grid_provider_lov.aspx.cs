...
public partial class grid_provider_lov : System.Web.UI.Page
{
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		switch (type) {
			...
			case "combogrid":
				ret = Pg.pagination(My.getParam("view"), My.getParam("page"), My.getParam("rows"), My.getParam("sort"), My.getParam("order"), My.getParam("filterRules"), My.getParam("preFilter"));
				My.print(ret);
				break;
		}
